 ...
 */
const { WEBSITE_NAME = '', PASSWD_PROTECT_ROUTES = '[]', USER_PRINCIPLE_NAME = '' } = process.env
...
module.exports = {
  ...
  userPrincipalName: USER_PRINCIPLE_NAME || 'me@lyc8503.site',
  ...
  footer: `${WEBSITE_NAME ?? 'OneDrive'} @${new Date().getFullYear()}`,

  // [OPTIONAL] This is where you specify the folders that are password protected. It is an array of paths pointing to all
  // the directories in which you have .password set. Check the documentation for details.
  protectedRoutes: JSON.parse(PASSWD_PROTECT_ROUTES) || [],
